...
export interface GQLAuthenticationMutationRoot {
  ...
  resetPasswordByEmail: GQLGeneralResponse;
}
...
export interface GQLResetPasswordByEmailInput {
  email: string;
}
...
> {
  ...
  resetPasswordByEmail?: AuthenticationMutationRootToResetPasswordByEmailResolver<TParent>;
}
...
export interface AuthenticationMutationRootToResetPasswordByEmailArgs {
  input?: GQLResetPasswordByEmailInput;
}
export interface AuthenticationMutationRootToResetPasswordByEmailResolver<
  TParent = GQLAuthenticationMutationRoot,
  TResult = GQLGeneralResponse
> {
  (
    parent: TParent,
    args: AuthenticationMutationRootToResetPasswordByEmailArgs,
    context: any,
    info: GraphQLResolveInfo
  ): Promise<TResult>;
}
